<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'agnaldo.junior9@outlook.com';//Trocar e-mail aqui!
		public $senha = 'metallica.com...';//Trocar senha aqui!
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'smtp.office365.com'; //SERVIDOR SMTP DA HOSPEDAGEM
